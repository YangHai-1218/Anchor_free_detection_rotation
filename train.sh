...
# efficientdet-d1
#CUDA_VISIBLE_DEVICES=0,1 python3 -m torch.distributed.launch --nproc_per_node=2 train.py --num_workers 4 --batch=8 --lr 0.002
#efficientdet-d2
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m torch.distributed.launch --nproc_per_node=4 train.py --num_workers 4 --batch=4 --lr 0.002
